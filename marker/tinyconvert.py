...
def convert_single_pdf(
    ...
    flush_cuda_memory()
    del layout_model  # flush python memory
    ...
    flush_cuda_memory()
    del texify_model  # flush python memory
    ...
    flush_cuda_memory()
    del edit_model  # flush python memory
